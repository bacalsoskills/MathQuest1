...
//       lessonService.getLessonCompletionStats(selectedLesson.id)
//         .then(stats => {
//           console.log(`[TeacherClassroomPage] Received completion stats:`, stats);
//           setStats(stats);
//           console.log(`[TeacherClassroomPage] Stats updated:`, {
//             readPercentage: stats.readPercentage,
//             quizCompletionPercentage: stats.quizCompletionPercentage,
//             totalStudents: stats.totalStudents,
//             studentsRead: stats.studentsRead,
//             studentsCompletedQuiz: stats.studentsCompletedQuiz
//           });

//           // Fetch students who read the lesson
//           if (stats.studentsRead > 0) {
//             console.log(`[TeacherClassroomPage] Fetching students who read lesson ${selectedLesson.id}`);
//             lessonService.getStudentsWhoReadLesson(selectedLesson.id)
//               .then(students => {
//                 console.log(`[TeacherClassroomPage] Received students who read:`, students);
//                 setStudentsWhoRead(students);
//               })
//               .catch(err => {
//                 console.error(`[TeacherClassroomPage] Error fetching students who read:`, err);
//               });
//           }
//         })
//         .catch(err => {
//           console.error(`[TeacherClassroomPage] Error fetching completion stats:`, err);
//           console.error(`[TeacherClassroomPage] Error details:`, err.response?.data);
//         });
//     }
//   }, [selectedLesson?.id]);
...
//               // Update the activity with quiz data
//               setSelectedLesson(prevLesson => {
//                 if (!prevLesson) return prevLesson;
                
//                 const updatedActivities = prevLesson.activities.map(act => {
...
//                 return { ...prevLesson, activities: updatedActivities };
//               });
//             })
//             .catch(err => {
...
//       }
//     }
//   }, [selectedLesson?.id, selectedLesson?.activities]);
...
//                               <h4 className="text-lg font-semibold mb-2">{activity.title || activity.quizData?.quizName || 'Quiz'}</h4>
//                               <p className="text-gray-600 mb-4">{activity.description || activity.quizData?.description}</p>
                              
//                               {/* Quiz Details */}
//                               <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
//                                 <div>
//                                   <span className="font-medium">Time Limit:</span> {activity.quizData?.timeLimitMinutes || 0} minutes
//                                 </div>
//                                 <div>
//                                   <span className="font-medium">Quiz Type:</span> {activity.quizData?.quizType ? 
//                                     activity.quizData.quizType.split('_').map(word => 
//                                       word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()
//                                     ).join(' ') : 'Quiz'}
//                                 </div>
//                                 <div>
//                                   <span className="font-medium">Passing Score:</span> {activity.quizData?.passingScore || 0}/{activity.quizData?.overallScore || 0}
//                                 </div>
//                                 <div>
//                                   <span className="font-medium">Max Attempts:</span> {activity.quizData?.maxAttempts || 'Unlimited'}
//                                 </div>
//                                 <div>
//                                   <span className="font-medium">Available From:</span> {activity.quizData?.availableFrom ? new Date(activity.quizData.availableFrom).toLocaleString() : 'Not set'}
//                                 </div>
//                                 <div>
//                                   <span className="font-medium">Available To:</span> {activity.quizData?.availableTo ? new Date(activity.quizData.availableTo).toLocaleString() : 'Not set'}
//                                 </div>
//                                 {activity.quizData?.attempts && (
//                                   <div>
//                                     <span className="font-medium">Total Attempts:</span> {activity.quizData.attempts.length || 0}
//                                   </div>
//                                 )}
//                               </div>
