...
const ClassroomService = {
  ...
  createClassroomAsAdmin: async (classroomData) => {
    try {
      console.log("Creating classroom as admin with data:", {
        name: classroomData.get("name"),
        description: classroomData.get("description"),
        teacherId: classroomData.get("teacherId"),
        hasImage: classroomData.has("image"),
      });
      ...
      console.error("Create classroom as admin error:", error);
      console.error("Error details:", {
        status: error.response?.status,
        data: error.response?.data,
        message: error.message,
  ...
  updateClassroomAsAdmin: async (classroomId, classroomData) => {
    try {
      console.log("Updating classroom as admin with ID:", classroomId);
      console.log("Update data:", classroomData);
      ...
      console.error("Update classroom as admin error:", error);
      console.error("Error details:", {
        status: error.response?.status,
        data: error.response?.data,
        message: error.message,
  ...
  addStudentToClassroomAsAdmin: async (classroomId, studentId) => {
    try {
      console.log(
        `Adding student ${studentId} to classroom ${classroomId} as admin`
      );
      const response = await api.post(
      ...
      console.error("Add student as admin error:", error);
      console.error("Error details:", {
        status: error.response?.status,
        data: error.response?.data,
        message: error.message,
